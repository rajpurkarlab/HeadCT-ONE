...
if __name__ == '__main__':
    ...
    parser.add_argument('--task', type=str, default=None, required=True, choices=['headct','headct_version2','mimic01','mimic02','ace04', 'ace05', 'scierc'])
    ...
    parser.add_argument('--dev_pred_filename', type=str, default="test.json", help="the prediction filename for the dev set")
    parser.add_argument('--test_pred_filename', type=str, default="env_pred_headct_findings_entities_test.json", help="the prediction filename for the test set")
    parser.add_argument('--train_data', type=str, default="./data/train.json", help="the prediction filename for the test set")
